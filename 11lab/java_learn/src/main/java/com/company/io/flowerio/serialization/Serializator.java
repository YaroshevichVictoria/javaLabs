...
public class Serializator {
    public boolean serialization(Flower flower, String fileName) {
        boolean flag = false;
        ...
        try {
            ...
            if (fos != null) {
                ...
                ostream.writeObject(flower); // сериализация
                flag = true;
            }
    ...
    public Flower deserialization(String fileName) throws InvalidObjectException {
        ...
        try {
            ...
            // десериализация
            return (Flower) istream.readObject();
